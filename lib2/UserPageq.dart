...
class _UserHomeState extends State<UserHome> {
  ...
  var test;
  _getAllformations() async {
    await CallApi().getData("formations").then((response) {
      test = response.body;
      setState(() {
        Iterable list = json.decode(response.body);
        //formations = list.map((model) => Formation.fromJson(model)).toList();
        print(list);
      });
    });
    print(test);
                ...
                children: [
                  Container(
                    ...
                    child: OutlinedButton(
                      onPressed: () => {_getAllformations()}, //_logout
