...
class MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    _auth() async {
    var res = await CallApi().postData({}, 'is_auth');
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: auth == false ? UserHome() : UserHome(),
...
//====================SUBMISSION BUTTON ==========================
  ...
  void _login(data, BuildContext context) async {
    var res = await CallApi().postData(data, 'login');
    var body = json.decode(res.body);
    print(body);

    if (await body['status'] == 200) {
      print("OUi tu as ouvert");
